...
bool _obscureText = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      elevation: 0,
      centerTitle: true,
      title: const Text('Login',style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),) ,
         ...
         ListView(
           ...
           children:[ Padding(
               ...
               const SizedBox(height:50),
                 Padding(
                   ...
                   child: TextField(
                    ...
                    decoration: InputDecoration(
                          ...
                          label:  Text('Enter E-mail address',style: TextStyle(color: Colors.grey.withOpacity(0.8)),),
                 ...
                 Padding(
                  ...
                  _obscureText = !_obscureText;
                      ...
                      label:  Text('Enter password',style: TextStyle(color: Colors.grey.withOpacity(0.8)),),
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(16),
                        borderSide: const BorderSide(color: kPrimaryColor),
                      ),
             ...
             Padding(
               ...
               child: CustomButton(text: 'Login', color: kPrimaryColor, onTap: () {
             ...
             Row(
              mainAxisAlignment: MainAxisAlignment.center,
               children: [
                 ...
                 GestureDetector(onTap: (){Navigator.pushNamed(context,const SignUp1().id);},
