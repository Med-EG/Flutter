...
class MedicalRecord2ForSecondDegree extends StatelessWidget {
  const MedicalRecord2ForSecondDegree({super.key});
  final String id = 'MedicalRecord2ForSecondDegree';
  @override
  Widget build(BuildContext context) {
    double screenHeight = MediaQuery.of(context).size.height;
    final Map<String, dynamic>? args =
        ModalRoute.of(context)?.settings.arguments as Map<String, dynamic>?;
    if (args != null && args.containsKey('second_degree')) {
      return SafeArea(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text(medicalRecord.second_degree!,
